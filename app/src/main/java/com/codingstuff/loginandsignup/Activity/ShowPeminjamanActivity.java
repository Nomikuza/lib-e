...
import com.codingstuff.loginandsignup.recyclerview.PeminjamanAdapter;
...
public class ShowPeminjamanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PeminjamanAdapter(mdata, getApplicationContext());
