...
import com.codingstuff.loginandsignup.Activity.PengembalianDetailsActivity;
...
public class PengembalianAdapter extends RecyclerView.Adapter<PengembalianAdapter.bookviewholder>{

    List<PeminjamanModel> list;

    private Context context;

    public PengembalianAdapter(List<PeminjamanModel> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull bookviewholder holder, int position) {
        ...
        holder.imgContainer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), PengembalianDetailsActivity.class);
